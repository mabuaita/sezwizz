...
Latency
The median 50th (P50) and 99th percentile (P99) round-trip latency times.


Errors/Sec
The number of errors (4xx and 5xx) processed per second.
...
Irate()
Instantaneous per-second rate of change.
